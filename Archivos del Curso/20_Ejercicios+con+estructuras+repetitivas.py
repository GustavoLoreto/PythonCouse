...
int_Numero = int (input("Introduce un numero para contarlo desde el uno hasta el número que introduzcas: "))
...
str_Titulo = "  Introducir tantas frases por teclado como deseemos y contarlas  "
print ("\n" + str_Titulo.center(80, "#" ) + "\n")
